...
const Element = (props) => {
	...
	return (
		<div className="flex ring-2 ring-yellow-500 p-2 rounded-md w-max bg-gray-700 h-full items-center justify-center ">
			<div
			...
			<div className=" w-20 ml-2 flex flex-col flex-wrap gap-2 h-28 max-h-28 justify-items-start">
				<button
